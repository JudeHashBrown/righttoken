export default {
    ...
    tools: {
      hermes: {
        ...
        sections: {
          ...
          config: {
            ...
            desc: 'In the Hermes model provider config, set base_url to https://api.righttoken.ai/v1 and paste your RightToken sk-... key.',
      ...
      workbuddy: {
        ...
        sections: {
          ...
          config: {
            title: 'Model configuration',
            desc: 'In the model configuration, set base_url to https://api.righttoken.ai/v1 and paste your RightToken sk-... key.',
      ...
      openclaw: {
        ...
        sections: {
          ...
          openai: {
            ...
            desc: 'In the OpenAI provider config, set base_url to https://api.righttoken.ai/v1 and paste your RightToken sk-... key.',
  ...
  nav: {
    ...
    referralAdmin: 'Invite Rewards',
    referralRules: 'Reward Rates',
    referralCommissions: 'Reward Records',
    settings: 'Settings',
  ...
  admin: {
    ...
    referral: {
      rulesTitle: 'Referral Reward Rates',
      rulesDescription: 'Manage Lv1 / Lv2 reward rates with full history',
      commissionsTitle: 'Referral Rewards',
      commissionsDescription: 'Review, pay out, and void referral rewards',
      tier1: 'Lv1 (direct invite) rate',
      tier2: 'Lv2 (indirect invite) rate',
      editRate: 'Edit rate',
      historyTitle: 'Rate history',
      colTier: 'Tier',
      colKind: 'Kind',
      kindLabels: {
        first_recharge: 'First top-up reward',
        agent_lv1: 'Direct reward (Lv1)',
        agent_lv2: 'Indirect reward (Lv2)',
      },
      colRate: 'Rate',
      ...
      rateHint: 'Range 0 ~ 1. Only affects newly accrued rewards; historical records are not rewritten.',
      ...
      statusSettled: 'Paid out',
      statusVoided: 'Voided',
      inviterIdPlaceholder: 'Inviter user ID',
      selectedCount: '{n} selected',
      markSettled: 'Mark paid out',
      markVoided: 'Void',
      confirmSettled: 'Confirm mark as paid out',
      confirmVoid: 'Confirm void',
      affectN: '{n} records will be updated',
      noteLabel: 'Note (optional)',
      empty: 'No reward records'
    }
  },
  ...
  referral: {
    ...
    pageDescription: 'Invite friends · earn rewards from their first top-up and ongoing usage',
    myInviteCode: 'My invite code',
    copyCode: 'Copy code',
    copyLink: 'Copy signup link',
    copied: 'Copied',
    // Invite benefits (visible to everyone)
    firstRechargeTitle: 'Invite friends — both of you get rewarded',
    firstRechargeBenefit1: 'Friends who sign up with your code get +5% extra balance on their first top-up (pay 100 → get 105).',
    firstRechargeBenefit2: 'When they use the API, you earn {rate} of their first top-up amount as rewards (capped at 5% of first top-up).',
    firstRechargeBenefit3: 'Only the first top-up counts; subsequent top-ups do not earn a new bonus.',
    ...
    lv1Title: 'Direct invite rewards',
    lv1Subtitle: 'Rewards from friends you invited',
    lv2Title: 'Indirect invite rewards',
    lv2Subtitle: 'Rewards from friends invited by your friends',
    lv2DownlineCount: 'Indirect invitees',
    pending: 'Pending payout',
    settled: 'Paid out',
    voided: 'Voided',
    lv1DownlinesTitle: 'Friends I invited',
    ...
    kindLabels: {
      first_recharge: 'First top-up reward',
      agent_lv1: 'Direct reward',
      agent_lv2: 'Indirect reward',
    },
    statusValues: {
      pending: 'Pending payout',
      settled: 'Paid out',
