export default {
  ...
  home: {
    ...
    newUserBonus: {
      title: '新用户专享测试额度',
      description: '新用户添加客服微信 RightToken 或 Telegram @Rightnow_ai，即可获赠价值 ¥5 的测试额度。'
    },
    // 新增：面向用户的价值主张
  ...
  dashboard: {
    ...
    newUserBonus: {
      title: '新用户福利',
      description: '添加客服微信 RightToken 或 Telegram @Rightnow_ai，即可获赠价值 ¥5 的测试额度。'
    },
    balance: '余额',
    apiKeys: 'API 密钥',
    todayRequests: '今日请求',
  ...
  admin: {
    ...
    referral: {
      rulesTitle: '邀请奖励费率',
      rulesDescription: '管理 Lv1 / Lv2 奖励比例（历史可追溯）',
      commissionsTitle: '邀请奖励记录',
      commissionsDescription: '查看、发放、作废邀请奖励',
      tier1: 'Lv1（直接邀请）费率',
      tier2: 'Lv2（间接邀请）费率',
      editRate: '修改费率',
      historyTitle: '费率历史',
      ...
      rateHint: '范围 0 ~ 1。改动只影响新产生的奖励，历史记录不会回溯。',
      ...
      statusSettled: '已发放',
      statusVoided: '已作废',
      inviterIdPlaceholder: '邀请人用户 ID',
      selectedCount: '已选中 {n} 条',
      markSettled: '标记已发放',
      markVoided: '作废',
      confirmSettled: '确认标记为已发放',
      confirmVoid: '确认作废',
      affectN: '影响 {n} 条记录',
      noteLabel: '备注（可选）',
      empty: '暂无奖励记录'
  ...
  payment: {
    ...
    qr: {
      ...
      scanUSDT: '使用 USDT 支付',
      scanUSDTHint: '扫描二维码或复制地址，并严格转入上方显示的金额',
      exactCryptoAmount: '应付金额（点击复制）',
      walletAddress: '收款地址',
      cryptoNetworkWarning: '仅可通过 {network} 网络转入 USDT，使用其他网络可能永久丢失资产',
  ...
  referral: {
    pageTitle: '我的邀请',
    pageDescription: '邀请朋友 · 朋友首充和长期使用都能让你获得奖励',
    myInviteCode: '我的邀请码',
    copyCode: '复制邀请码',
    copyLink: '复制注册链接',
    copied: '已复制',
    // 邀请奖励介绍（任何人可见）
    firstRechargeTitle: '邀请朋友，双方都能得到奖励',
    firstRechargeBenefit1: '朋友用你的邀请码注册，首次充值额外 +5% 余额（充 100 得 105）',
    firstRechargeBenefit2: '朋友使用时，你按其首充金额累计 {rate} 奖励（封顶为首充金额的 5%）',
    firstRechargeBenefit3: '仅对朋友的首次充值生效，后续充值不重复发放',
    ...
    lv1Title: '直接邀请奖励',
    lv1Subtitle: '你邀请的朋友使用时获得的奖励',
    lv2Title: '间接邀请奖励',
    lv2Subtitle: '朋友再邀请的人使用时获得的奖励',
    lv2DownlineCount: '间接邀请人数',
    pending: '待发放',
    settled: '已发放',
    voided: '已作废',
    lv1DownlinesTitle: '我邀请的朋友',
    colDownline: '用户邮箱',
    colJoinedAt: '注册时间',
    colUsageTotal: '累计使用',
    colMyCommission: '我的奖励',
    noDownlines: '暂无邀请，把邀请码发给朋友吧',
    commissionLogTitle: '奖励明细',
    statusAll: '全部',
    colTime: '时间',
    colTier: '类型',
    colKind: '类型',
