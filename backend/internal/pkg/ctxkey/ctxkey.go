...
const (
	...
	// RegistrationIP is the trusted client IP attached only to user-creation
	// flows. Repositories must never use it to overwrite an existing value.
	RegistrationIP Key = "ctx_registration_ip"
