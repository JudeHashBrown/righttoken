...
type User struct {
	...
	// IsReferralPartner holds the value of the "is_referral_partner" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldCreatedAt, user.FieldUpdatedAt, user.FieldDeletedAt, user.FieldTotpEnabledAt, user.FieldReferralBonusClaimedAt:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldIsReferralPartner:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field is_referral_partner", values[i])
			} else if value.Valid {
				_m.IsReferralPartner = value.Bool
			}
		case user.FieldReferralBonusClaimedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field referral_bonus_claimed_at", values[i])
			} else if value.Valid {
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("is_referral_partner=")
	builder.WriteString(fmt.Sprintf("%v", _m.IsReferralPartner))
	builder.WriteString(", ")
	if v := _m.ReferralBonusClaimedAt; v != nil {
